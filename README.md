...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jsonargparse-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13809&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jsonargparse-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jsonargparse` can be installed with:

```
conda install jsonargparse
```

It is possible to list all of the versions of `jsonargparse` available on your platform with:
